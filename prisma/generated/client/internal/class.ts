...
config.runtimeDataModel = JSON.parse("{\"models\":{\"ConnectionTest\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"ConnectionTest.findUnique\",\"ConnectionTest.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"ConnectionTest.findFirst\",\"ConnectionTest.findFirstOrThrow\",\"ConnectionTest.findMany\",\"data\",\"ConnectionTest.createOne\",\"ConnectionTest.createMany\",\"ConnectionTest.createManyAndReturn\",\"ConnectionTest.updateOne\",\"ConnectionTest.updateMany\",\"ConnectionTest.updateManyAndReturn\",\"create\",\"update\",\"ConnectionTest.upsertOne\",\"ConnectionTest.deleteOne\",\"ConnectionTest.deleteMany\",\"having\",\"_count\",\"_min\",\"_max\",\"ConnectionTest.groupBy\",\"ConnectionTest.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"contains\",\"startsWith\",\"endsWith\",\"not\",\"set\"]"),
...
export interface PrismaClientConstructor {
   ...
   * })
   * // Fetch zero or more ConnectionTests
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.connectionTest`: Exposes CRUD operations for the **ConnectionTest** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ConnectionTests
    * const connectionTests = await prisma.connectionTest.findMany()
    * ```
    */
  get connectionTest(): Prisma.ConnectionTestDelegate<ExtArgs, { omit: OmitOpts }>;
}
