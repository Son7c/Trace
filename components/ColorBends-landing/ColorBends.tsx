...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // The canvas sits behind the hero content, which otherwise intercepts its
    // pointer events. Listen at window level while retaining container-relative
    // coordinates for the shader.
